...
async function createCraftElement(craft) {
  ...
  craftDiv.addEventListener("click", async function () {
...
(async () => {
  try {
    ...
    data.forEach(async (craft) => {
      const craftElement = await createCraftElement(craft);
